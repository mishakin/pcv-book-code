...
disp('      with uncertain image and certain scene points       ')
disp('                    (PCV Alg. 17)                         ')
disp('----------------------------------------------------------')
...
for i = 1:N_samples
    ...
    % perturb point pairs (sigma_X is set to 0)
    [X,y] = sugr_perturb_3D_2D_point_pairs(Xt,yt,0,sigma_y,factor_p);
